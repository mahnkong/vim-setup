...
for plugin in yegappan/mru scrooloose/syntastic ervandew/supertab Raimondi/delimitMate majutsushi/tagbar fatih/vim-go scrooloose/nerdtree vim-scripts/YankRing.vim Shougo/neocomplete.vim altercation/vim-colors-solarized.git vim-airline/vim-airline; do
    echo "Plugin: $plugin"
